...
// Direct import of model schema to avoid path/env issues with using the project's model file directly if it has side effects
const BlogPostSchema = new mongoose.Schema({
    ...
    author: { type: String, default: 'Bergaman', trim: true },
    readTime: { type: String, default: '5 min read' },
    views: { type: Number, default: 0 },
    likes: { type: Number, default: 0 },
    comments: [{ name: String, email: String, message: String, date: { type: Date, default: Date.now } }],
    published: { type: Boolean, default: true },
    featured: { type: Boolean, default: false },
    visibility: { type: String, enum: ['public', 'password', 'members', 'private'], default: 'public' },
...
const MONGODB_URI = "mongodb+srv://bergaman:bergaman77@cluster0.i8kyq.mongodb.net/bergaman-dev";
...
async function seed() {
    try {
        ...
        // Check if posts already exist to avoid duplicates (by slug)
