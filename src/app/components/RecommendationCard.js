...
export default function RecommendationCard({ 
  ...
  // Link Card - Enhanced Design
  if (recommendation.category === 'link') {
    const linkUrl = recommendation.link || recommendation.url;
    
    return (
      <div className="bg-[#2e3d29]/30 backdrop-blur-md border border-[#3e503e]/30 hover:border-[#e8c547]/50 rounded-lg overflow-hidden transition-all duration-300 relative group h-full max-h-[240px]">
        {/* Admin Controls */}
        {isAdminMode && onEdit && (
