...
export default function AdminContacts() {
  ...
  return (
    <div className="min-h-screen text-[#d1d5db]">
      <Head>
          ...
          <div className="bg-[#2e3d29]/30 backdrop-blur-md border border-[#3e503e]/30 p-6 rounded-lg">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-[#e8c547]">{statistics.total || 0}</p>
              </div>
              <i className="fas fa-envelope text-2xl text-[#e8c547]"></i>
            </div>
          </div>
          ...
          <div className="bg-[#2e3d29]/30 backdrop-blur-md border border-[#3e503e]/30 p-6 rounded-lg">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-blue-400">{statistics.new || 0}</p>
              </div>
          ...
          <div className="bg-[#2e3d29]/30 backdrop-blur-md border border-[#3e503e]/30 p-6 rounded-lg">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-yellow-400">{statistics.read || 0}</p>
              </div>
              <i className="fas fa-envelope-open text-2xl text-yellow-400"></i>
            </div>
          </div>
          ...
          <div className="bg-[#2e3d29]/30 backdrop-blur-md border border-[#3e503e]/30 p-6 rounded-lg">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-green-400">{statistics.replied || 0}</p>
              </div>
              <i className="fas fa-reply text-2xl text-green-400"></i>
            </div>
          </div>
        </div>
